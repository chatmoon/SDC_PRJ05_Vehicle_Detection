...
var       = parameters()
if not os.path.exists(args.pickled + 'heat_list.p'): 
    pickle.dump(heat_list, open(args.pickled + 'heat_list.p', 'wb'))
...
def process_image(image):
    ...
    # script
    if os.path.exists(args.pickled + 'heat_list.p'):  # de-serialize/load heat_list
        heat_list = pickle.load(open(args.pickled + "heat_list.p", "rb"))
    ...
    pickle.dump(heat_list, open(args.pickled + "heat_list.p", 'wb')) # serialize/store heat_list
